...
public class Main extends JPanel 
{
    ...
    public Main() 
    {
        m_board.addPlayer(new Player("Prachet"), new SimpleStrategy());
        m_board.addPlayer(new Player("Kamal"));
        m_board.addPlayer(new Player("Sai"));
        m_board.addPlayer(new Player("Zubair"));
        add(jButton1);
